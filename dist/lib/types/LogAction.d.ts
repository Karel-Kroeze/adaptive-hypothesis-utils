...
export declare type contentVerb = "add" | "remove" | "change" | "clear";
export declare type processVerb = "access" | "start" | "cancel" | "send" | "receive";
export declare type storageVerb = "new" | "open" | "create" | "update" | "delete";
export declare type otherVerb = "application_started" | "phase_changed";
export declare type verb = contentVerb | processVerb | storageVerb | otherVerb;
